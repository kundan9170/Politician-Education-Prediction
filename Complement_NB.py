...
alpha_value = 0.6
complement_nb_model = ComplementNB(alpha = alpha_value)

# Train the model using the training dataset
complement_nb_model.fit(X_train, y_train)

# Make predictions on the test data
test_predictions = complement_nb_model.predict(X_test)
...
# Initialize the ComplementNB Classifier
complement_nb_model_full = ComplementNB(alpha = alpha_value)

# Train the model using the entire dataset
complement_nb_model_full.fit(X, y)
...
test_predictions = complement_nb_model_full.predict(test_data)
