...
multinomial_nb_model = MultinomialNB(alpha=alpha_value)

# Train the model using the training dataset
multinomial_nb_model.fit(X_train, y_train)

# Make predictions on the test data
test_predictions = multinomial_nb_model.predict(X_test)
...
# Initialize the BernoulliNB Classifier with custom alpha parameter
multinomial_nb_model_full = MultinomialNB(alpha=alpha_value)

# Train the model using the entire dataset
multinomial_nb_model_full.fit(X, y)
...
test_predictions = multinomial_nb_model_full.predict(test_data)
